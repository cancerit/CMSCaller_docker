...
# hadolint ignore=DL3059
RUN R -e "install.packages(c('devtools','BiocManager'), lib = Sys.getenv(\"R_LIBS_USER\"), Ncpus = Sys.getenv(\"INST_NCPU\"))"
# hadolint ignore=DL3059
...
RUN R -e "BiocManager::install(c('Biobase', 'limma'), lib = Sys.getenv(\"R_LIBS_USER\"), threads = Sys.getenv(\"INST_NCPU\"))"
